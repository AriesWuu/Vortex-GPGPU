...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N5_D6d_Az17_O1___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__commit__DOT__g_commit_arbs__BRA__0__KET____DOT__commit_arb(Vrtlsim_shim_VX_stream_arb__N5_D6d_Az17_O1* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N5_D6d_Az17_O1___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__commit__DOT__g_commit_arbs__BRA__0__KET____DOT__commit_arb\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<4>/*127:0*/ __Vtemp_2;
    // Body
    VL_RAND_RESET_ASSIGN_W(109, __Vtemp_2);
    vlSelfRef.__Vxrand_h4712dbe9__0[0U] = __Vtemp_2[0U];
    vlSelfRef.__Vxrand_h4712dbe9__0[1U] = __Vtemp_2[1U];
    vlSelfRef.__Vxrand_h4712dbe9__0[2U] = __Vtemp_2[2U];
    vlSelfRef.__Vxrand_h4712dbe9__0[3U] = (0x1fffU 
                                           & __Vtemp_2[3U]);
...
VL_ATTR_COLD void Vrtlsim_shim_VX_stream_arb__N5_D6d_Az17_O1___ctor_var_reset(Vrtlsim_shim_VX_stream_arb__N5_D6d_Az17_O1* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                          Vrtlsim_shim_VX_stream_arb__N5_D6d_Az17_O1___ctor_var_reset\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_RAND_RESET_W(109, vlSelf->__Vxrand_h4712dbe9__0);
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->reset = VL_RAND_RESET_I(1);
    vlSelf->valid_in = VL_RAND_RESET_I(5);
    VL_RAND_RESET_W(545, vlSelf->data_in);
    vlSelf->ready_in = VL_RAND_RESET_I(5);
    vlSelf->valid_out = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(109, vlSelf->data_out);
    ...
    VL_RAND_RESET_W(113, vlSelf->g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb1__DOT__pipe_buffer__DOT____Vcellinp__g_register__DOT__g_pipe_regs__BRA__0__KET____DOT__pipe_register__data_in);
    VL_RAND_RESET_W(113, vlSelf->__PVT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb1__DOT__pipe_buffer__DOT__g_register__DOT__g_pipe_regs__BRA__0__KET____DOT__pipe_register__DOT__g_shift_register__DOT__g_shift__DOT__pipe);
}
