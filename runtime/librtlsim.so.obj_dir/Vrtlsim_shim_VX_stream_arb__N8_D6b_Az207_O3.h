...
#ifndef VERILATED_VRTLSIM_SHIM_VX_STREAM_ARB__N8_D6B_AZ207_O3_H_
#define VERILATED_VRTLSIM_SHIM_VX_STREAM_ARB__N8_D6B_AZ207_O3_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_stream_arb__N8_D6b_Az207_O3 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vrtlsim_shim_VX_stream_arb__N8_D6b_Az207_O3(Vrtlsim_shim__Syms* symsp, const char* v__name);
    ~Vrtlsim_shim_VX_stream_arb__N8_D6b_Az207_O3();
    VL_UNCOPYABLE(Vrtlsim_shim_VX_stream_arb__N8_D6b_Az207_O3);
