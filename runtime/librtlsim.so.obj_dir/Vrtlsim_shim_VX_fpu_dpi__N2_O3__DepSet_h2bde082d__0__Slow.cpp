...
VL_ATTR_COLD void Vrtlsim_shim_VX_fpu_dpi__N2_O3___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__execute__DOT__fpu_unit__DOT__g_blocks__BRA__0__KET____DOT__fpu_dpi(Vrtlsim_shim_VX_fpu_dpi__N2_O3* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vrtlsim_shim_VX_fpu_dpi__N2_O3___eval_initial__TOP__rtlsim_shim__DOT__vortex__DOT__g_clusters__BRA__0__KET____DOT__cluster__DOT__g_sockets__BRA__0__KET____DOT__socket__DOT__g_cores__BRA__0__KET____DOT__core__DOT__execute__DOT__fpu_unit__DOT__g_blocks__BRA__0__KET____DOT__fpu_dpi\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlWide<3>/*95:0*/ __Vtemp_2;
    VlWide<3>/*95:0*/ __Vtemp_4;
    // Body
    vlSelfRef.__Vxrand_h8d93e5fb__0 = (0x3ffU & VL_RAND_RESET_ASSIGN_I(10));
    vlSelfRef.__Vxrand_h7d2804ec__0 = VL_RAND_RESET_ASSIGN_Q(64);
    VL_RAND_RESET_ASSIGN_W(71, __Vtemp_2);
    vlSelfRef.div_sqrt_arb__DOT____Vxrand_h6dacdbac__0[0U] 
        = __Vtemp_2[0U];
    vlSelfRef.div_sqrt_arb__DOT____Vxrand_h6dacdbac__0[1U] 
        = __Vtemp_2[1U];
    vlSelfRef.div_sqrt_arb__DOT____Vxrand_h6dacdbac__0[2U] 
        = (0x7fU & __Vtemp_2[2U]);
    VL_RAND_RESET_ASSIGN_W(71, __Vtemp_4);
    vlSelfRef.rsp_arb__DOT____Vxrand_h6dacdbac__0[0U] 
        = __Vtemp_4[0U];
    vlSelfRef.rsp_arb__DOT____Vxrand_h6dacdbac__0[1U] 
        = __Vtemp_4[1U];
    vlSelfRef.rsp_arb__DOT____Vxrand_h6dacdbac__0[2U] 
        = (0x7fU & __Vtemp_4[2U]);
}

VL_ATTR_COLD void Vrtlsim_shim_VX_fpu_dpi__N2_O3___ctor_var_reset(Vrtlsim_shim_VX_fpu_dpi__N2_O3* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vrtlsim_shim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vrtlsim_shim_VX_fpu_dpi__N2_O3___ctor_var_reset\n"); );
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->__Vxrand_h8d93e5fb__0 = VL_RAND_RESET_I(10);
    ...
    vlSelf->mask_in = VL_RAND_RESET_I(2);
    vlSelf->tag_in = VL_RAND_RESET_I(1);
    vlSelf->op_type = VL_RAND_RESET_I(4);
    vlSelf->fmt = VL_RAND_RESET_I(2);
    vlSelf->frm = VL_RAND_RESET_I(3);
    vlSelf->dataa = VL_RAND_RESET_Q(64);
    vlSelf->datab = VL_RAND_RESET_Q(64);
    vlSelf->datac = VL_RAND_RESET_Q(64);
    ...
    VL_RAND_RESET_W(71, vlSelf->__Vcellout__div_sqrt_arb__data_out);
    vlSelf->__Vcellinp__div_sqrt_arb__valid_in = VL_RAND_RESET_I(2);
    vlSelf->__PVT__g_fma__DOT__result_fma = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fadd);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fsub);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fmul);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fmadd);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fmsub);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fnmadd);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fma__DOT__result_fnmsub);
    vlSelf->__PVT__g_fma__DOT__fflags_fma = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fadd = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fsub = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fmul = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fmadd = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fmsub = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fnmadd = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fma__DOT__fflags_fnmsub = VL_RAND_RESET_I(10);
    ...
    VL_RAND_RESET_W(71, vlSelf->__Vcellinp__g_fma__DOT__shift_reg__data_in);
    vlSelf->__PVT__g_fdiv__DOT__result_fdiv_r = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fdiv__DOT__result_fdiv);
    vlSelf->__PVT__g_fdiv__DOT__fflags_fdiv = VL_RAND_RESET_I(10);
    ...
    VL_RAND_RESET_W(71, vlSelf->__Vcellinp__g_fdiv__DOT__shift_reg__data_in);
    vlSelf->__PVT__g_fsqrt__DOT__result_fsqrt_r = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fsqrt__DOT__result_fsqrt);
    vlSelf->__PVT__g_fsqrt__DOT__fflags_fsqrt = VL_RAND_RESET_I(10);
    ...
    VL_RAND_RESET_W(71, vlSelf->__Vcellinp__g_fsqrt__DOT__shift_reg__data_in);
    vlSelf->__PVT__g_fcvt__DOT__result_fcvt = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fcvt__DOT__result_itof);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fcvt__DOT__result_utof);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fcvt__DOT__result_ftoi);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fcvt__DOT__result_ftou);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fcvt__DOT__result_f2f);
    vlSelf->__PVT__g_fcvt__DOT__fflags_fcvt = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fcvt__DOT__fflags_itof = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fcvt__DOT__fflags_utof = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fcvt__DOT__fflags_ftoi = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fcvt__DOT__fflags_ftou = VL_RAND_RESET_I(10);
    ...
    VL_RAND_RESET_W(71, vlSelf->__Vcellinp__g_fcvt__DOT__shift_reg__data_in);
    vlSelf->__PVT__g_fncp__DOT__result_fncp = VL_RAND_RESET_Q(64);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fclss);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_flt);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fle);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_feq);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fmin);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fmax);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fsgnj);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fsgnjn);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fsgnjx);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fmvx);
    VL_RAND_RESET_W(128, vlSelf->__PVT__g_fncp__DOT__result_fmvf);
    vlSelf->__PVT__g_fncp__DOT__fflags_fncp = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fncp__DOT__fflags_flt = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fncp__DOT__fflags_fle = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fncp__DOT__fflags_feq = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fncp__DOT__fflags_fmin = VL_RAND_RESET_I(10);
    vlSelf->__PVT__g_fncp__DOT__fflags_fmax = VL_RAND_RESET_I(10);
    ...
    VL_RAND_RESET_W(72, vlSelf->__Vcellinp__g_fncp__DOT__shift_reg__data_in);
    vlSelf->__Vlvbound_h6231ca99__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h0abda082__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h15445df1__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h80136d17__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_hbed391a6__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_hb52fe345__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h6250e315__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h3dfb837d__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h3c57a994__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h3bb99f94__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_hfe10685b__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h28cd2d5a__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_he591c311__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h7e29cf30__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h5bd473e8__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h039f89f3__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h5f26c9f9__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h968cac1b__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h581913c0__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_he1ea5c1e__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h975ac400__0 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h975ac400__1 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h975ac400__2 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h975ac400__3 = VL_RAND_RESET_I(5);
    vlSelf->__Vlvbound_h975ac400__4 = VL_RAND_RESET_I(5);
    VL_RAND_RESET_W(71, vlSelf->div_sqrt_arb__DOT____Vxrand_h6dacdbac__0);
    VL_RAND_RESET_W(71, vlSelf->rsp_arb__DOT____Vxrand_h6dacdbac__0);
    vlSelf->__PVT__rsp_arb__DOT__g_input_select__DOT__g_arbiter__DOT__arb_onehot = VL_RAND_RESET_I(4);
    VL_RAND_RESET_W(73, vlSelf->rsp_arb__DOT____Vcellinp__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__data_in);
    ...
    VL_RAND_RESET_W(73, vlSelf->__PVT__rsp_arb__DOT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb2__DOT__stream_buffer__DOT__g_buffer__DOT__data_out_r);
    VL_RAND_RESET_W(73, vlSelf->__PVT__rsp_arb__DOT__g_input_select__DOT__g_arbiter__DOT__g_out_buf__BRA__0__KET____DOT__out_buf__DOT__g_eb2__DOT__stream_buffer__DOT__g_buffer__DOT__buffer_r);
    ...
    VL_RAND_RESET_W(284, vlSelf->__PVT__g_fma__DOT__shift_reg__DOT__g_shift__DOT__pipe);
    VL_RAND_RESET_W(1065, vlSelf->__PVT__g_fdiv__DOT__shift_reg__DOT__g_shift__DOT__pipe);
    VL_RAND_RESET_W(710, vlSelf->__PVT__g_fsqrt__DOT__shift_reg__DOT__g_shift__DOT__pipe);
    VL_RAND_RESET_W(355, vlSelf->__PVT__g_fcvt__DOT__shift_reg__DOT__g_shift__DOT__pipe);
    VL_RAND_RESET_W(144, vlSelf->__PVT__g_fncp__DOT__shift_reg__DOT__g_shift__DOT__pipe);
    vlSelf->__VdfgRegularize_hb092f51d_0_2 = VL_RAND_RESET_I(1);
