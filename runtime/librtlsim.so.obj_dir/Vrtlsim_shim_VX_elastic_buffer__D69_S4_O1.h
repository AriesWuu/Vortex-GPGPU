...
#ifndef VERILATED_VRTLSIM_SHIM_VX_ELASTIC_BUFFER__D69_S4_O1_H_
#define VERILATED_VRTLSIM_SHIM_VX_ELASTIC_BUFFER__D69_S4_O1_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vrtlsim_shim_VX_elastic_buffer__D69_S4_O1 final : public VerilatedModule {
  public:
    ...
    VL_INW(data_in,104,0,4);
    VL_OUTW(data_out,104,0,4);
    VlWide<4>/*104:0*/ __PVT__g_ebN__DOT__fifo_queue__DOT__g_depth_n__DOT__g_out_reg__DOT__data_out_r;
    VlUnpacked<VlWide<4>/*104:0*/, 4> __PVT__g_ebN__DOT__fifo_queue__DOT__g_depth_n__DOT__dp_ram__DOT__ram;

    // INTERNAL VARIABLES
    Vrtlsim_shim__Syms* const vlSymsp;

    // CONSTRUCTORS
    Vrtlsim_shim_VX_elastic_buffer__D69_S4_O1(Vrtlsim_shim__Syms* symsp, const char* v__name);
    ~Vrtlsim_shim_VX_elastic_buffer__D69_S4_O1();
    VL_UNCOPYABLE(Vrtlsim_shim_VX_elastic_buffer__D69_S4_O1);
